...
# (iii) Translate in X and Y direction
...
def draw():                                            	# ondraw is called all the time
    ...
    glTranslatef() take three argument
    first argument is the translation in x direction
    second argument is the translation in y direction
    third argument is the translation in x direction
